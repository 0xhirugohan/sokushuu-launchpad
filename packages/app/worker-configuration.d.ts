// Generated by Wrangler by running `wrangler types` (hash: a4e3f7113840b662a92be34bf4d310f1)
// Runtime types generated with workerd@1.20250409.0 2025-04-04 
declare namespace Cloudflare {
	interface Env {
		VALUE_FROM_CLOUDFLARE: string; // "Hello from Cloudflare default" | "this is from dev" | "this is from devnet";
		APP_VERSION: string;
	}
}
