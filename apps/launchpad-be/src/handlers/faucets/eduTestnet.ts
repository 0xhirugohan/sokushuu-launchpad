...
import { eduTestnetChain } from '../../libs'
...
const eduTestnet = async (c: Context<{ Bindings: Bindings }>) => {
    ...
    const KVKey = `faucet.edu.testnet.${toAddress}`;
